...
The ```R``` programming language and its statistical and machine learning libraries were used to build all applied algorithms as well as to generate most figures. 
