...
# This script utilizes SHAP (SHapley Additive exPlanations) to explain the output of the random forest algorithm.
...
# Shapley values.
shap <- explain(random_forest, X = features, nsim = 100, pred_wrapper = prediction)
